        ...
        <>  
            ...
            <section className='min-w-[100vw] overflow-hidden relative'>
                <main className='myContainer min-h-screen flex items-center'>
                    <h2 style={poppins.style} className='my-8 text-sky-500 text-2xl'>Opps! you don&apos;t have any Nano Link saved yet. Please add some</h2>
                    <Link href='/auth/SignIn' style={poppins.style} className='text-xl hover:text-blue-500 hover:underline'>New Link?</Link>
